    ...
    rest_1.post('/todo-lists/{id}/todos', {
        responses: {
            '200': {
                ...
                content: {
                    'application/json': { schema: { 'x-ts-type': models_1.Todo } },
                },
            },
        },
    }),
...
TodoListTodoController = __decorate([
    __param(0, repository_1.repository(todo_list_repository_1.TodoListRepository)),
    __metadata("design:paramtypes", [todo_list_repository_1.TodoListRepository])
